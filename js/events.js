...
var NEORONS_EVENTS = [
  ...
  },
  {
    ...
    credit: null,
    pillar: "ai",
    title: "Classroom 2030: Bhopal",
    district: "Bhopal",
    state: "Madhya Pradesh",
    venue: "Teacher-training venue to be announced, Bhopal",
    date: "August 2026",
    blurb:
      "Our teacher AI-literacy summit travels to central India: two days of hands-on training for government-school teachers across Bhopal district.",
    description: [
      "Classroom 2030 is coming to Bhopal. Over two days, teachers from government schools across the district will rebuild real lessons with AI assistants, practise generating differentiated material for mixed-ability classrooms, and work through the limits: bias, privacy, and where a teacher's judgement must stay in charge.",
      "Registration opens through district education channels in July 2026. Schools that want to send teachers can also write to us directly.",
    ],
    highlights: [
      "Two days of hands-on practice, following the Pune summit model",
      "Materials in Hindi and English",
      "Every participating school leaves with a draft AI-use policy",
    ],
    figures: [
      { number: "120", label: "teacher places planned" },
  ...
  },
  {
    ...
    credit: null,
    pillar: "stem",
    title: "Project Jigyasa: Brahmaputra",
    district: "Kamrup Metropolitan",
    state: "Assam",
    venue: "Government schools across Kamrup Metropolitan district",
    date: "September 2026",
    blurb:
      "The travelling science fair heads to the Northeast: three weeks of hands-on stations, telescope nights, and a student exhibition in and around Guwahati.",
    description: [
      "Project Jigyasa's next road trip takes the travelling laboratory to government schools in Kamrup Metropolitan district, our first programme in the Northeast. The format that worked in Varanasi travels whole: hands-on stations, take-home experiments from low-cost materials, telescope evenings, and a closing exhibition where students present their own working models.",
      "We are currently mapping schools and river-crossing logistics with local educators. Schools in and around Guwahati can register interest by email.",
    ],
    highlights: [
      "First Neorons programme in the Northeast",
      "Three weeks on the road across the district",
      "Closes with a student-led exhibition for families",
    ],
    figures: [
      { number: "10", label: "schools planned" },
      { number: "3", label: "weeks on the road" },
    ],
    partners: [],
    outcomes: [],
  ...
  },
  {
    ...
    credit: null,
    pillar: "inclusion",
    title: "Makeathon for All: Kochi",
    district: "Ernakulam",
    state: "Kerala",
    venue: "Community makerspace, Kochi",
    date: "November 2026",
    blurb:
      "The mixed-team assistive-technology makeathon comes to Kerala: blind and sighted students building together over one weekend in Kochi.",
    description: [
      "After Mysuru showed us what mixed teams can build in two days, Makeathon for All travels to Kochi. Blind and low-vision students will again be designers and decision-makers on every team, working alongside sighted peers on one brief: build something that makes daily life or learning easier.",
      "We are working with local schools for the blind and a Kochi makerspace on dates and equipment. The Mysuru prototypes, including the clip-on ultrasonic cane attachment, will be on the benches as starting points to improve, not just admire.",
    ],
    highlights: [
      "Mixed teams of blind and sighted student makers",
      "Builds on three prototypes carried forward from Mysuru",
      "One weekend, working prototypes by Sunday evening",
    ],
    figures: [
      { number: "60", label: "student places planned" },
      { number: "2", label: "days of building" },
    ],
    partners: [],
    outcomes: [],
    reflection: null,
